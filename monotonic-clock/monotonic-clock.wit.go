...
// Package monotonicclock represents the imported interface "wasi:clocks/monotonic-clock@0.2.4".
//
...
// Pollable represents the imported type alias "wasi:clocks/monotonic-clock@0.2.4#pollable".
//
// See [poll.Pollable] for more information.
type Pollable = poll.Pollable

// Instant represents the u64 "wasi:clocks/monotonic-clock@0.2.4#instant".
//
...
// Duration represents the u64 "wasi:clocks/monotonic-clock@0.2.4#duration".
//
