...
// Package timezone represents the imported interface "wasi:clocks/timezone@0.2.7".
package timezone
...
// DateTime represents the type alias "wasi:clocks/timezone@0.2.7#datetime".
//
// See [wallclock.DateTime] for more information.
type DateTime = wallclock.DateTime

// TimezoneDisplay represents the record "wasi:clocks/timezone@0.2.7#timezone-display".
//
